                      ...
                      <div className="p-6 bg-gray-50 rounded-xl dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                              Review the terms of service for using
                              CaribbeanRecipe
                            </p>
                            <Link
                              href="/terms"
                      ...
                      <div className="p-6 bg-gray-50 rounded-xl dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                              Learn about our community standards and how to be
                              a respectful member
                            </p>
                            <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-2 mb-4 ml-5">
                              ...
                              <li className="list-disc">
                                Share authentic recipes and cooking experiences
                              </li>
                              <li className="list-disc">
                                No spam, harassment, or inappropriate content
                              </li>
                              <li className="list-disc">
                                Give credit when sharing others&apos; recipes
                              </li>
                            </ul>
                            <Link
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-gray-50 rounded-lg">
                        ...
                        >
                          ...
                          <option value="es">
                            {t("settings.preferences.languages.es")}
                          </option>
                          <option value="fr">
                            {t("settings.preferences.languages.fr")}
                          </option>
                          <option value="de">
                            {t("settings.preferences.languages.de")}
                          </option>
                        </select>
                      </div>
                    </div>
